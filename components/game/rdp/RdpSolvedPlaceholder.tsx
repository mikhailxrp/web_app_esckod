...
interface RdpSolvedPlaceholderProps {
  onClose: () => void;
}

export function RdpSolvedPlaceholder({ onClose }: RdpSolvedPlaceholderProps): ReactElement {
  return (
    <div className="flex flex-col items-center gap-6 px-6 py-12 text-center">
      ...
      <p className="font-mono text-game-sm text-content-secondary">
        Раздел в разработке. Windows-симуляция будет доступна в следующем обновлении.
      </p>
